...
const AdminDashboard = () => {
  ...
  return (
    <div
      className="admin-container dashboard-enhanced"
    ...
    >
      ...
      <div className="action-cards" style={styles.flexRow}>
        <Link
          ...
          className="stat-card"
          style={{ ...styles.card, borderRight: '5px solid #f39c12' }}
        >
        ...
        <Link
          ...
          className="stat-card"
          style={{ ...styles.card, borderRight: '5px solid #9b59b6' }}
        >
          <div className="stat-icon" style={{ fontSize: '2rem' }}>
            🚀
          </div>
      ...
      <div className="dashboard-grid" style={styles.grid}>
        ...
        >
          <div style={{ color: '#616161', fontWeight: 'bold' }}>
            תגובות ודירוגים
          </div>
          <div style={{ fontSize: '2rem', margin: '10px 0' }}>
            {stats.reviewsTotal}
      ...
      >
        <div className="analytics-card" style={styles.card}>
          <h3
            style={{ borderBottom: '2px solid #f1c40f', paddingBottom: '10px' }}
          >
            🏆 מובילים בדירוג
          </h3>
        ...
        <div className="analytics-card" style={styles.card}>
          <h3
            style={{ borderBottom: '2px solid #e67e22', paddingBottom: '10px' }}
          >
            🔥 הכי פופולריים
          </h3>
          <div className="ranking-list" style={{ marginTop: '15px' }}>
