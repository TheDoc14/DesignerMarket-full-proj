...
const ResetPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.message || 'חלה שגיאה בעיבוד הבקשה. ייתכן והלינק פג תוקף.');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="admin-container" style={{ maxWidth: '500px', margin: '40px auto' }}>
            <h1>איפוס סיסמה</h1>
            ...
            {!token ? (
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-group" style={{ flexDirection: 'column', gap: '5px' }}>
                    ...
                    <div className="form-group" style={{ flexDirection: 'column', gap: '5px', marginTop: '10px' }}>
                    ...
                    <button type="submit" disabled={loading || !token} style={{ width: '100%', marginTop: '20px' }}>
            ...
            {error && token && <div className="alert alert-error" style={{ marginTop: '15px' }}>{error}</div>}
        </div>
    );
};
