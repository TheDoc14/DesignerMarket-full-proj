  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} style={formStyle}>
          ...
          <div style={imageGridStyle}>
            {existingFiles.map((file) => (
              ...
              >
                ...
                {currentMainImageId === file.id && (
                  <span style={badgeStyle}>ראשי</span>
                )}
              </div>
            ))}
          </div>
        ...
        <label style={labelStyle}>תגיות (מופרדות בפסיקים)</label>
        <input
          style={inputStyle}
          value={formData.tags}
          onChange={(e) => setFormData({ ...formData, tags: e.target.value })}
        />
        <label style={labelStyle}>אימייל PayPal למשיכת כספים</label>
        <input
          type="email"
          style={inputStyle}
        ...
        <label style={labelStyle}>מחיר (ב₪)</label>
        <input
          type="number"
          style={inputStyle}
